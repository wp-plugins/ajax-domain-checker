...
4. or Add shortcode [wpdomainchecker] to your post or page.

== Frequently Asked Questions ==

= How to use with shortcode ? =

easily use [wpdomainchecker]

also, you can custom button text and width size with:

[wpdomainchecker width="YOUR DESIRED WIDTH" button="YOUR DESIRED TEXT BUTTON"]
